...
export const RESEARCH_DIRECTION_SUMMARY_PILLARS: ResearchSummaryPillar[] = [
	{
		title: "边缘AI推理优化",
		body: "需要开展大模型和视觉模型的量化、剪枝、蒸馏及异构硬件加速。降低模型在边缘终端运行时的算力、功耗、时延和网络带宽需求。 ",
	},
	{
		title: "体育动作识别算法",
		body: "需要提升拳击等高速对抗运动中的动作识别、目标跟踪和姿态分析能力。重点解决遮挡、快速移动、多目标交互和复杂比赛环境下的识别精度问题。",
	},
	{
		title: "医疗数据与模型安全",
		body: "需要建设医疗数据脱敏、权限控制、隐私计算和模型安全评测体系。解决大模型幻觉、数据泄露、结果追溯及医院私有化部署等问题。  ",
	},
	{
		title: "通信测试验证平台",
		body: "需要建设覆盖协议、设备、网络性能、安全性和场景适配的验证平台。支持国产芯片、通信终端和智能网络技术的仿真测试与产业化认证。",
	},
	{
		title: "工业智能分析",
		body: "需要研发设备故障诊断、预测性维护、视觉质检和工业时序分析模型。结合生产工艺数据，提高异常发现、质量控制和生产决策的智能化水平。 ",
	},
	{
		title: "车联网边缘智能",
		body: "需要研发车路云协同、边缘缓存、任务卸载和动态资源调度技术。提升车辆高速移动环境下的数据处理效率、网络稳定性和服务质量。",
	},
	{
		title: "联邦学习与隐私计算",
		body: "需要建立适用于医疗、汽车和工业场景的分布式模型训练体系。在数据不出域的条件下，实现跨机构模型协同、隐私保护和持续更新。",
	},
	{
		title: "具身智能技术储备",
		body: "需要补充机器人感知、导航、运动规划、实时控制和仿真训练能力。推动EdgeOS向康养机器人、医院物流机器人和工业巡检机器人延伸。",
	},
];
